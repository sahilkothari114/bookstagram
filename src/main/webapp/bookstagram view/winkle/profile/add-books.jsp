                ...
                <div class="container">
                    ...
                    <div class="row heading-bg">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h5 class="txt-dark">Add Books</h5>
                        </div>
                        <!-- Breadcrumb -->
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                <li><a href="index2.html">Bookstagram</a></li>
                                <li class="active"><span>Add Books</span></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
                    </div>
                            ...
                            <div class="panel panel-default card-view">
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div class="form-wrap">
                                            <form action="SearchBook" class="col-sm-6" method="GET">
                                                <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>Search book</h6>
                                                <hr class="light-grey-hr"/>
                                                <div class="form-group mb-30">
                                                    <label class="control-label mb-10 m-t-20" for="example-input1-group3"></label>

                                                    <div class="input-group mb-15">
                                                        <input type="text" id="example-input2-group3" name="Book" class="form-control" placeholder="ISBN or Keywords (Titles, Authors...)">
                                                        <div class="input-group-btn">
                                                            <button type="button" class="btn  btn-info dropdown-toggle" data-toggle="dropdown"><i class="fa fa-search"></i> <span class="caret"></span></button>
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a><Button type="submit" style="    background:none!important;
                                                                               border:none; 
                                                                               width:100%;
                                                                               ">ISBN</button></a></li>
                                                                <li><a><Button type="submit" style="    background:none!important;
                            ...
                            <div class="panel panel-default card-view">
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-2">
                                                    <img src="<c:out value="${Book.cover}"/>"> 
                                            </div>

                                            <div class="col-md-9">
                                                <div class="product-detail-wrap">

                                                    <h3 class="mb-20 weight-500"><c:out value="${Book.title}"/></h3>
                                                    <p class="mb-50"><c:out value="${Book.description}"/></p>
                                                    ...
                                                    <form action="SearchBook" class="col-sm-6" method="GET">
                                                        ...
                                                        <div class="form-group mb-30">
                                                            ...
                                                            <div class="input-group mb-15">
                                                                ...
                                                                <button type="button" class="btn  btn-info dropdown-toggle" data-toggle="dropdown">Add To<span class="caret"></span></button>
                                                                <ul class="dropdown-menu dropdown-menu-right">
                                                                    <li><a><Button type="submit" style="    background:none!important;
                                                                                   border:none; 
                                                                                   width:100%;
